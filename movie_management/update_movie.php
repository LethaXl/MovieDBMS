...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update'])) {
        ...
        if ($field === 'MOVIE_ID' || $field === 'PRICE_PURCHASE' || $field === 'PRICE_RENTAL') {
        ...
        $sql = "UPDATE movie SET $field = :newValue WHERE MOVIE_ID = :identifierValue";
    ...
    if (isset($_POST['delete'])) {
        ...
        if (!is_numeric($deleteIdentifier)) {
            ...
            $deleteIdentifier = (int)$deleteIdentifier;

            $sql = "DELETE FROM movie WHERE MOVIE_ID = :deleteIdentifier";
            $stid = oci_parse($conn, $sql);
...
<head>
    ...
    <title>Update or Delete Movie</title>
    <style>
        body {
    ...
    <div class="form-container">
        <form method="POST" action="">
            ...
            <select id="field_name" name="field_name" required>
                ...
                <option value="PRICE_PURCHASE">PRICE_PURCHASE</option>
                <option value="PRICE_RENTAL">PRICE_RENTAL</option>
            </select>

            <label for="new_value">New value:</label>
            <input type="text" id="new_value" name="new_value" placeholder="e.g., newprice" required>

            <label for="identifier">Identifier value (e.g., 4 for MOVIE_ID):</label>
        ...
        <form method="POST" action="">
            <h2>Delete Movie</h2>
            <label for="delete_identifier">Movie ID to delete:</label>
